...
# 3A. PROMPT LEAKAGE GEval. We are creating a custom evaluation metric to judge whether the model is leaking hidden prompts or internal instructions. Higher score is better.
...
# 3B. COURSE CONTENT LEAKAGE GEval. We are creating a custom evaluation metric to judge whether the model is leaking course content. Higher score is better.
